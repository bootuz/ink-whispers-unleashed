...
export const HeroSection = ({ searchQuery, onSearch, onKeyPress }: HeroSectionProps) => {
  return (
    <div className="flex flex-col items-center text-center px-4 py-8 md:py-12 bg-gradient-to-b from-purple-50 to-white rounded-lg mb-10">
      <h1 
        className="text-5xl md:text-6xl mb-4 tracking-wider"
        style={{
